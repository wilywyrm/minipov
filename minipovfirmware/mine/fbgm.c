...
//#include <avr/signal.h> // deprecated, replaced by interrupt.h
...
// it says FbGM (fuck bitches, get money OR forget bread, get muffins)
...
uint8_t j = 0;
SIGNAL( TIMER1_COMPA_vect ) { //SIG_TIMER1_COMPA is poisoned (deprecated)
  if (j >= imagesize) 
    j = 0;
